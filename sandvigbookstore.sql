...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Jun-2017 às 18:23
...
--
-- Indexes for table `bookauthorsbooks`
--
...
--
-- Indexes for table `bookcategoriesbooks`
--
ALTER TABLE `bookcategoriesbooks`
  ADD PRIMARY KEY (`CategoryID`,`ISBN`);

--
-- Indexes for table `bookcustomers`
--
ALTER TABLE `bookcustomers`
  ADD PRIMARY KEY (`custID`);

--
-- Indexes for table `bookdescriptions`
--
